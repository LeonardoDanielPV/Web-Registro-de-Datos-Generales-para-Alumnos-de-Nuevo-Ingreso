...
!function(t, e) {
    ...
    f.jQueryDetection(),
    d.default.fn.emulateTransitionEnd = c,
    d.default.event.special[f.TRANSITION_END] = {
        bindType: u,
        delegateType: u,
        handle: function(t) {
    ...
    var h = "alert"
      ...
      , _ = function() {
        ...
        ,
        t.dispose = function() {
            d.default.removeData(this._element, g),
            this._element = null
        }
        ,
        t._getRootElement = function(t) {
            ...
            n = n || d.default(t).closest(".alert")[0]
        }
        ,
        ...
        t._removeElement = function(e) {
            ...
            d.default(e).hasClass("fade") ? (t = f.getTransitionDurationFromElement(e),
            d.default(e).one(f.TRANSITION_END, function(t) {
    ...
    d.default(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', _._handleDismiss(new _)),
    d.default.fn[h] = _._jQueryInterface,
    d.default.fn[h].Constructor = _,
    d.default.fn[h].noConflict = function() {
        return d.default.fn[h] = m,
        _._jQueryInterface
    }
    ;
    var p = "button"
      ...
      , C = function() {
        ...
        return t.toggle = function() {
            ...
            !i || (t = this._element.querySelector(w)) && ("radio" === t.type && (t.checked && this._element.classList.contains(b) ? e = !1 : (i = i.querySelector(".active")) && d.default(i).removeClass(b)),
            e && ("checkbox" !== t.type && "radio" !== t.type || (t.checked = !this._element.classList.contains(b)),
            d.default(t).trigger("change")),
            t.focus(),
            n = !1),
            this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (n && this._element.setAttribute("aria-pressed", !this._element.classList.contains(b)),
            e && d.default(this._element).toggleClass(b))
        }
        ,
        t.dispose = function() {
            d.default.removeData(this._element, v),
            this._element = null
        }
        ,
    ...
    d.default(document).on("click.bs.button.data-api", E, function(t) {
        var e = t.target
          , n = e;
        if (d.default(e).hasClass("btn") || (e = d.default(e).closest(T)[0]),
    ...
    d.default.fn[p] = C._jQueryInterface,
    d.default.fn[p].Constructor = C,
    d.default.fn[p].noConflict = function() {
        return d.default.fn[p] = y,
        C._jQueryInterface
    }
    ;
    var S = "carousel"
      ...
      , q = function() {
        ...
        t.to = function(t) {
            ...
            if (!(t > this._items.length - 1 || t < 0))
                if (this._isSliding)
                    d.default(this._element).one(P, function() {
                        return e.to(t)
                    });
                else {
                    if (n === t)
        ...
        t.dispose = function() {
            ...
            d.default.removeData(this._element, D),
            this._items = null,
            this._config = null,
            this._element = null,
            this._interval = null,
        ...
        t._setActiveIndicatorElement = function(t) {
            ...
            d.default(e).removeClass(R),
            (t = this._indicatorsElement.children[this._getItemIndex(t)]) && d.default(t).addClass(R))
        }
        ,
        t._slide = function(t, e) {
            var n, i, o, a = this, s = this._element.querySelector(x), l = this._getItemIndex(s), r = e || s && this._getItemByDirection(t, s), u = this._getItemIndex(r), e = Boolean(this._interval), t = t === O ? (n = "carousel-item-left",
            i = "carousel-item-next",
            "left") : (n = "carousel-item-right",
            i = "carousel-item-prev",
            "right");
            r && d.default(r).hasClass(R) ? this._isSliding = !1 : this._triggerSlideEvent(r, t).isDefaultPrevented() || s && r && (this._isSliding = !0,
            e && this.pause(),
            ...
            d.default(s).one(f.TRANSITION_END, function() {
                d.default(r).removeClass(n + " " + i).addClass(R),
                d.default(s).removeClass(R + " " + i + " " + n),
                a._isSliding = !1,
                setTimeout(function() {
                    return d.default(a._element).trigger(o)
                }, 0)
            }).emulateTransitionEnd(u)) : (d.default(s).removeClass(R),
            d.default(r).addClass(R),
            this._isSliding = !1,
        ...
        o._dataApiClickHandler = function(t) {
            ...
            !i || (e = d.default(i)[0]) && d.default(e).hasClass("carousel") && (n = r(r({}, d.default(e).data()), d.default(this).data()),
            (i = this.getAttribute("data-slide-to")) && (n.interval = !1),
            o._jQueryInterface.call(d.default(e), n),
            i && d.default(e).data(D).to(i),
            t.preventDefault())
        }
        ,
        s(o, null, [{
    ...
    d.default(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", q._dataApiClickHandler),
    ...
    d.default.fn[S] = q._jQueryInterface,
    d.default.fn[S].Constructor = q,
    d.default.fn[S].noConflict = function() {
        return d.default.fn[S] = A,
        q._jQueryInterface
    }
    ;
    var F = "collapse"
      ...
      , X = function() {
        ...
        t.show = function() {
            ...
            i && (n = d.default(i).not(this._selector).data(Q)) && n._isTransitioning || (t = d.default.Event("show.bs.collapse"),
            d.default(this._element).trigger(t),
            t.isDefaultPrevented() || (i && (a._jQueryInterface.call(d.default(i).not(this._selector), "hide"),
            n || d.default(i).data(Q, null)),
            e = this._getDimension(),
            d.default(this._element).removeClass(W).addClass(V),
            this._element.style[e] = 0,
            this._triggerArray.length && d.default(this._triggerArray).removeClass(z).attr("aria-expanded", !0),
            ...
            d.default(this._element).one(f.TRANSITION_END, function() {
                d.default(o._element).removeClass(V).addClass(W + " " + M),
                o._element.style[e] = "",
        ...
        t.hide = function() {
            ...
            if (!this._isTransitioning && d.default(this._element).hasClass(M)) {
                ...
                !e.isDefaultPrevented()) {
                    ...
                    d.default(this._element).addClass(V).removeClass(W + " " + M);
                    ...
                    d.default(this._element).one(f.TRANSITION_END, function() {
                        ...
                        d.default(t._element).removeClass(V).addClass(W).trigger("hidden.bs.collapse")
        ...
        ,
        t.dispose = function() {
            d.default.removeData(this._element, Q),
            this._config = null,
            this._parent = null,
            this._element = null,
        ...
        ,
        t._getConfig = function(t) {
            return (t = r(r({}, H), t)).toggle = Boolean(t.toggle),
            f.typeCheckConfig(F, t, U),
            t
        }
        ,
    ...
    d.default.fn[F] = X._jQueryInterface,
    d.default.fn[F].Constructor = X,
    d.default.fn[F].noConflict = function() {
        return d.default.fn[F] = B,
        X._jQueryInterface
    }
    ;
    var Y = "dropdown"
      ...
      , ut = function() {
        ...
        return t.toggle = function() {
            var t;
            this._element.disabled || d.default(this._element).hasClass(nt) || (t = d.default(this._menu).hasClass(it),
            u._clearMenus(),
            t || this.show(!0))
        }
        ,
        t.show = function(t) {
            if (void 0 === t && (t = !1),
            !(this._element.disabled || d.default(this._element).hasClass(nt) || d.default(this._menu).hasClass(it))) {
                var e = {
                ...
                !n.isDefaultPrevented()) {
                    if (!this._inNavbar && t) {
                        ...
                        t = this._element;
                        "parent" === this._config.reference ? t = i : f.isElement(this._config.reference) && (t = this._config.reference,
                    ...
                    d.default(this._menu).toggleClass(it),
                    d.default(i).toggleClass(it).trigger(d.default.Event("shown.bs.dropdown", e))
                }
            }
        }
        ,
        t.hide = function() {
            ...
            e = d.default.Event(tt, t),
            n = u._getParentFromElement(this._element),
            d.default(n).trigger(e),
            e.isDefaultPrevented() || (this._popper && this._popper.destroy(),
            d.default(this._menu).toggleClass(it),
            d.default(n).toggleClass(it).trigger(d.default.Event(et, t))))
        }
        ,
        t.dispose = function() {
            d.default.removeData(this._element, $),
            d.default(this._element).off(J),
            this._element = null,
        ...
        ,
        t._getConfig = function(t) {
            return t = r(r(r({}, this.constructor.Default), d.default(this._element).data()), t),
            f.typeCheckConfig(Y, t, this.constructor.DefaultType),
            t
        }
        ,
        t._getMenuElement = function() {
            var t;
            return this._menu || (t = u._getParentFromElement(this._element)) && (this._menu = t.querySelector(st)),
            this._menu
        }
        ,
        t._getPlacement = function() {
            var t = d.default(this._element.parentNode)
              , e = "bottom-start";
            return t.hasClass("dropup") ? e = d.default(this._menu).hasClass(ot) ? "top-end" : "top-start" : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : d.default(this._menu).hasClass(ot) && (e = "bottom-end"),
            e
        }
        ,
        ...
        u._clearMenus = function(t) {
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                for (var e = [].slice.call(document.querySelectorAll(at)), n = 0, i = e.length; n < i; n++) {
                    var o, a, s = u._getParentFromElement(e[n]), l = d.default(e[n]).data($), r = {
                        relatedTarget: e[n]
                    };
                    t && "click" === t.type && (r.clickEvent = t),
                    l && (o = l._menu,
                    d.default(s).hasClass(it) && (t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && d.default.contains(s, t.target) || (a = d.default.Event(tt, r),
                    d.default(s).trigger(a),
                    a.isDefaultPrevented() || ("ontouchstart"in document.documentElement && d.default(document.body).children().off("mouseover", null, d.default.noop),
                    e[n].setAttribute("aria-expanded", "false"),
                    l._popper && l._popper.destroy(),
                    d.default(o).removeClass(it),
                    d.default(s).removeClass(it).trigger(d.default.Event(et, r))))))
                }
        }
        ,
            ...
            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || d.default(t.target).closest(st).length)) : Z.test(t.which)) && !this.disabled && !d.default(this).hasClass(nt)) {
                ...
                if (n || 27 !== t.which) {
                    ...
                    !n || n && (27 === t.which || 32 === t.which))
                        return 27 === t.which && d.default(e.querySelector(at)).trigger("focus"),
    ...
    d.default(document).on(n, at, ut._dataApiKeydownHandler).on(n, st, ut._dataApiKeydownHandler).on(e + " keyup.bs.dropdown.data-api", ut._clearMenus).on(e, at, function(t) {
        t.preventDefault(),
        t.stopPropagation(),
        ut._jQueryInterface.call(d.default(this), "toggle")
    }).on(e, ".dropdown form", function(t) {
        t.stopPropagation()
    }),
    d.default.fn[Y] = ut._jQueryInterface,
    d.default.fn[Y].Constructor = ut,
    d.default.fn[Y].noConflict = function() {
        return d.default.fn[Y] = G,
        ut._jQueryInterface
    }
    ;
    var dt = "modal"
      ...
      , kt = function() {
        ...
        t.show = function(t) {
            var e, n = this;
            this._isShown || this._isTransitioning || (d.default(this._element).hasClass(Ct) && (this._isTransitioning = !0),
            e = d.default.Event(pt, {
                relatedTarget: t
            }),
            ...
            d.default(this._element).on(bt, '[data-dismiss="modal"]', function(t) {
                return n.hide(t)
            }),
        ...
        t.hide = function(t) {
            ...
            (t = d.default(this._element).hasClass(Ct)) && (this._isTransitioning = !0),
            this._setEscapeEvent(),
            this._setResizeEvent(),
            d.default(document).off(vt),
            d.default(this._element).removeClass(St),
            d.default(this._element).off(bt),
            d.default(this._dialog).off(wt),
            t ? (t = f.getTransitionDurationFromElement(this._element),
            d.default(this._element).one(f.TRANSITION_END, function(t) {
        ...
        t.dispose = function() {
            ...
            d.default(document).off(vt),
            d.default.removeData(this._element, ct),
            this._config = null,
            this._element = null,
            this._dialog = null,
            this._backdrop = null,
        ...
        t._triggerBackdropTransition = function() {
            ...
            if ("static" === this._config.backdrop) {
                ...
                d.default(this._element).off(f.TRANSITION_END),
                d.default(this._element).one(f.TRANSITION_END, function() {
                    t._element.classList.remove(Dt),
                    n || d.default(t._element).one(f.TRANSITION_END, function() {
        ...
        t._showElement = function(t) {
            ...
            d.default(this._element).addClass(St),
            ...
            n ? (n = f.getTransitionDurationFromElement(this._dialog),
            d.default(this._dialog).one(f.TRANSITION_END, t).emulateTransitionEnd(n)) : t()
        }
        ,
        ...
        t._hideModal = function() {
            ...
            this._isTransitioning = !1,
            this._showBackdrop(function() {
                d.default(document.body).removeClass(Tt),
                t._resetAdjustments(),
                t._resetScrollbar(),
                d.default(t._element).trigger(_t)
            })
        }
        ,
        ...
        t._showBackdrop = function(t) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                d.default(this._backdrop).addClass(St),
                !t)
                    return;
                if (!n)
                    return void t();
                ...
                !this._isShown && this._backdrop ? (d.default(this._backdrop).removeClass(St),
                n = function() {
                    e._removeBackdrop(),
                    t && t()
                }
                ,
                d.default(this._element).hasClass(Ct) ? (i = f.getTransitionDurationFromElement(this._backdrop),
                d.default(this._backdrop).one(f.TRANSITION_END, n).emulateTransitionEnd(i)) : n()) : t && t()
            }
        }
        ,
        ...
        t._setScrollbar = function() {
            var t, e, o = this;
            this._isBodyOverflowing && (t = [].slice.call(document.querySelectorAll(Nt)),
    ...
    d.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(t) {
        var e, n = this, i = f.getSelectorFromElement(this);
    ...
    d.default.fn[dt] = kt._jQueryInterface,
    d.default.fn[dt].Constructor = kt,
    d.default.fn[dt].noConflict = function() {
        return d.default.fn[dt] = ht,
        kt._jQueryInterface
    }
    ;
        ...
        for (var t = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(o), s = [].slice.call(t.body.querySelectorAll("*")), n = function(t) {
            ...
            t.forEach(function(t) {
                !function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n))
                        return -1 === It.indexOf(n) || Boolean(t.nodeValue.match(Ot) || t.nodeValue.match(jt));
      ...
      , $t = function() {
        ...
        t.toggle = function(t) {
            if (this._isEnabled)
                if (t) {
                    ...
                    if (d.default(this.getTipElement()).hasClass(Kt))
        ...
        t.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                ;
                d.default(this.tip).hasClass(zt) ? (n = f.getTransitionDurationFromElement(this.tip),
                d.default(this.tip).one(f.TRANSITION_END, t).emulateTransitionEnd(n)) : t()
            }
        }
        ,
        t.hide = function(t) {
            function e() {
                n._hoverState !== Wt && i.parentNode && i.parentNode.removeChild(i),
                n._cleanTipClass(),
            ...
            o.isDefaultPrevented() || (d.default(i).removeClass(Kt),
            ...
            d.default(this.tip).hasClass(zt) ? (o = f.getTransitionDurationFromElement(i),
            d.default(i).one(f.TRANSITION_END, e).emulateTransitionEnd(o)) : e(),
            this._hoverState = "")
        }
        ,
        t.update = function() {
        ...
        t.setContent = function() {
            ...
            d.default(t).removeClass(zt + " " + Kt)
        }
        ,
        t.setElementContent = function(t, e) {
            "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Pt(e, this.config.whiteList, this.config.sanitizeFn)),
        ...
        t._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(t) {
                ...
                "click" === t ? d.default(n.element).on(n.constructor.Event.CLICK, n.config.selector, function(t) {
                    return n.toggle(t)
                }) : "manual" !== t && (e = t === Xt ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN,
                t = t === Xt ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT,
        ...
        t._enter = function(t, e) {
            ...
            t && (e._activeTrigger["focusin" === t.type ? Yt : Xt] = !0),
            d.default(e.getTipElement()).hasClass(Kt) || e._hoverState === Wt ? e._hoverState = Wt : (clearTimeout(e._timeout),
            e._hoverState = Wt,
        ...
        t._leave = function(t, e) {
            ...
            (e = e || d.default(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
            d.default(t.currentTarget).data(n, e)),
            t && (e._activeTrigger["focusout" === t.type ? Yt : Xt] = !1),
        ...
        t._getConfig = function(t) {
            ...
            f.typeCheckConfig(Rt, t, this.constructor.DefaultType),
        ...
        t._fixTransition = function() {
            ...
            null === t.getAttribute("x-placement") && (d.default(t).removeClass(zt),
    ...
    d.default.fn[Rt] = $t._jQueryInterface,
    d.default.fn[Rt].Constructor = $t,
    d.default.fn[Rt].noConflict = function() {
        return d.default.fn[Rt] = qt,
        $t._jQueryInterface
    }
    ;
    var Jt = "popover"
    ...
    d.default.fn[Jt] = se._jQueryInterface,
    d.default.fn[Jt].Constructor = se,
    d.default.fn[Jt].noConflict = function() {
        return d.default.fn[Jt] = te,
        se._jQueryInterface
    }
    ;
    var le = "scrollspy"
      ...
      , ve = function() {
        function n(t, e) {
            ...
            this._config = this._getConfig(e),
            this._selector = this._config.target + " " + me + "," + this._config.target + " " + _e + "," + this._config.target + " .dropdown-item",
            this._offsets = [],
            this._targets = [],
        ...
        ,
        t.dispose = function() {
            d.default.removeData(this._element, re),
            d.default(this._scrollElement).off(ue),
            this._element = null,
        ...
        t._getConfig = function(t) {
            var e;
            return "string" != typeof (t = r(r({}, ce), "object" == typeof t && t ? t : {})).target && f.isElement(t.target) && ((e = d.default(t.target).attr("id")) || (e = f.getUID(le),
            d.default(t.target).attr("id", e)),
            t.target = "#" + e),
            f.typeCheckConfig(le, t, fe),
            t
        }
        ,
        ...
        t._activate = function(e) {
            ...
            t.hasClass("dropdown-item") ? (t.closest(".dropdown").find(".dropdown-toggle").addClass(he),
            t.addClass(he)) : (t.addClass(he),
            t.parents(ge).prev(me + ", " + _e).addClass(he),
            t.parents(ge).prev(".nav-item").children(me).addClass(he)),
    ...
    d.default.fn[le] = ve._jQueryInterface,
    d.default.fn[le].Constructor = ve,
    d.default.fn[le].noConflict = function() {
        return d.default.fn[le] = de,
        ve._jQueryInterface
    }
    ;
    var ye = "bs.tab"
      ...
      , Ce = function() {
        ...
        return t.show = function() {
            ...
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && d.default(this._element).hasClass(Ee) || d.default(this._element).hasClass("disabled") || (a = d.default(this._element).closest(".nav, .list-group")[0],
            e = f.getSelectorFromElement(this._element),
            a && (o = "UL" === a.nodeName || "OL" === a.nodeName ? Te : we,
            n = (n = d.default.makeArray(d.default(a).find(o)))[n.length - 1]),
            ...
            a = function() {
                ...
                d.default(s._element).trigger(e)
            }
            ,
        ...
        ,
        t.dispose = function() {
            d.default.removeData(this._element, ye),
            this._element = null
        }
        ,
        t._activate = function(t, e, n) {
            ...
            o && a ? (a = f.getTransitionDurationFromElement(o),
            d.default(o).removeClass("show").one(f.TRANSITION_END, e).emulateTransitionEnd(a)) : e()
        }
        ,
        t._transitionComplete = function(t, e, n) {
            var i;
            e && (d.default(e).removeClass(Ee),
            (i = d.default(e.parentNode).find("> .dropdown-menu .active")[0]) && d.default(i).removeClass(Ee),
            "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)),
            d.default(t).addClass(Ee),
    ...
    d.default(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        Ce._jQueryInterface.call(d.default(this), "show")
    }),
    d.default.fn.tab = Ce._jQueryInterface,
    d.default.fn.tab.Constructor = Ce,
    d.default.fn.tab.noConflict = function() {
        return d.default.fn.tab = be,
        Ce._jQueryInterface
    }
    ;
    var Se = "toast"
      ...
      , Pe = function() {
        ...
        return t.show = function() {
            ...
            d.default(this._element).one(f.TRANSITION_END, t).emulateTransitionEnd(n)) : t())
        }
        ,
        t.hide = function() {
            var t;
            this._element.classList.contains(ke) && (t = d.default.Event("hide.bs.toast"),
            d.default(this._element).trigger(t),
        ...
        t.dispose = function() {
            ...
            d.default(this._element).off(Ae),
            d.default.removeData(this._element, De),
            this._element = null,
            this._config = null
        }
        ,
        t._getConfig = function(t) {
            return t = r(r(r({}, je), d.default(this._element).data()), "object" == typeof t && t ? t : {}),
            f.typeCheckConfig(Se, t, this.constructor.DefaultType),
            t
        }
        ,
        t._setListeners = function() {
        ...
        t._close = function() {
            ...
            d.default(this._element).one(f.TRANSITION_END, t).emulateTransitionEnd(e)) : t()
        }
        ,
